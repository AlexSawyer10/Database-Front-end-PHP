...
<main>
    <div class="text-center">
        ...
        <h2 class="my-5">Continue to the Product page here -> <a href="unauthenticated_product.php" class="product btn mb-1 text-decoration-underline">Product</a></h2>

        <h2 class="my-5">Continue to the Vendor page here -> <a href="unauthenticated_vendor.php" class="product btn mb-1 text-decoration-underline">Vendor</a></h2>
